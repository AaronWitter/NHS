...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision "shell", inline: <<PROVISIONSCRIPT
    ...
    apt-get -y install oracle-java8-installer    wget -q http://www.mirrorservice.org/sites/ftp.apache.org/maven/maven-3/3.3.1/binaries/apache-maven-3.3.1-bin.tar.gz -O /tmp/apache-maven-3.3.1-bin.tar.gz
    cd /tmp
